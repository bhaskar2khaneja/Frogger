...
OFILES = main.o myLib.o gameStartImage.o gameOverImage.o gameWinImage.o frog.o car.o font.o house.o river.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = myLib.h gameStartImage.h gameOverImage.h gameWinImage.h frog.h car.h house.h river.h
